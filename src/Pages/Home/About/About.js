...
const About = () => {
    return (
        <div>
            <h3 className='text-center text-3xl  mb-3 font-semibold text-primary'>About</h3>
            <div className="card lg:card-side bg-base-100 rounded-none grid grid-cols-1 md:grid-cols-2 h-full my-10 border border-primary rounded-xl">
